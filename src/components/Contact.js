    ...
    <section id="contact" className="py-12 md:py-20 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 mb-6 md:mb-8">Get In Touch</h2>
          ...
          <div className="flex justify-center flex-wrap gap-3 md:gap-4 mb-8 md:mb-12">
            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=gowsikrajan006@gmail.com" target="_blank" rel="noopener noreferrer" className="group">
              <motion.div 
                className="bg-blue-600 w-12 h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-xl relative overflow-hidden"
            ...
            <a href="https://github.com/gowsikrcs23-lang" target="_blank" rel="noopener noreferrer" className="hover:transform hover:scale-110 transition-all duration-300">
              <div className="bg-blue-600 w-12 h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl">
          ...
          <motion.a 
            ...
            className="inline-block bg-blue-600 hover:bg-blue-700 px-6 md:px-8 py-2 md:py-3 rounded-lg font-semibold text-white transition-all duration-300 shadow-lg hover:shadow-xl text-sm md:text-base"
